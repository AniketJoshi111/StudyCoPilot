...
public class ResearchService {
    ...
    private String extractTextFromResponse(String response) {
        try{
            ...
            return "No content found in resp";
        } catch (Exception e) {
    ...
    private String buildPrompt(ResearchRequest request)
    {
        ...
        switch(request.getOperation())
        {
            case "summarize":
                ...
                break;
            case "suggest":
                prompt.append("Based on the following content: suggest related topics and further reading . Format the responses with a clear headings and bullet points");
                break;
            default:
